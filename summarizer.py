...
#run file auth.py, which should be created for authorization in Hugging Face, according to readme instruction
import auth 

class SimpleSummarizer():

    def __init__(self, model_id: str):
        #parameter is model_id, such as "google/flan-t5-small", attribute llm is created while creating an instance
    ...
    def summarize(self, text_to_summarize: str):
        # the method takes text and returns the summary of this text

        # prompt with system instruction and text to process
        messages = [
            SystemMessage(content="Write a concise summary of the following:"),
            HumanMessage(content=text_to_summarize),
        ]

        # run llm with the message
...
if __name__ == "__main__":
    ...
    # create an instance of SimpleSummarizer
    ...
    # use summarize method of SimpleSummarizer class for test_text
